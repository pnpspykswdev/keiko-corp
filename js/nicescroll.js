...
(function (f) {
    ...
    var v = window.MutationObserver || window.WebKitMutationObserver || !1, I = {
        ...
        this.bind = function (b, c, d, f) {
            ...
            // Handle mousewheel events with passive: false
            if ("mousewheel" === c) {
                if (window.addEventListener || "onwheel" in document) {
                    a._bind(h, "wheel", d, { passive: false, capture: f || false });
                } else {
                    b = "undefined" !== typeof document.onmousewheel ? "mousewheel" : "DOMMouseScroll";
                    n(h, b, d, { passive: false, capture: f || false });
                    "DOMMouseScroll" === b && n(h, "MozMousePixelScroll", d, { passive: false, capture: f || false });
                }
            } else if (h.addEventListener) {
                // Bind touch events with passive: false
                if (e.cantouch && /mouseup|mousedown|mousemove/.test(c)) {
                    a._bind(h, "mousedown" === c ? "touchstart" : "mouseup" === c ? "touchend" : "touchmove", function (a) {
                        if (a.touches) {
                    ...
                    }, { passive: false, capture: f || false });
                }
                a._bind(h, c, d, { passive: false, capture: f || false });
                e.cantouch && "mouseup" === c && a._bind(h, "touchcancel", d, { passive: false, capture: f || false });
            } else {
                a._bind(h, c, function (b) {
                    b = b || window.event || false;
                    if (b && b.srcElement) b.target = b.srcElement;
                    if (!("pageY" in b)) {
                        b.pageX = b.clientX + document.documentElement.scrollLeft;
                        b.pageY = b.clientY + document.documentElement.scrollTop;
                    }
                    return d.call(h, b) === false || f === false ? a.cancelEvent(b) : true;
                });
            }
        };
